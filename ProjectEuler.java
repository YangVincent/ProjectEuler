...
public class ProjectEuler 
{
    ...
    public void printMenu()
    {
        ...
        System.out.println("Run problem number: ");
    }
    private void runProblem(int input, ProjectEuler tester)
    {
        if (input == -1)
            return;
        switch (input)
    ...
    public static void main(String[] args)
    {
        ...
        while (input != 0)
        {
            tester.runProblem(input, tester);
            Scanner m_scanner = new Scanner(System.in);
            tester.printMenu();
            input = m_scanner.nextInt();
        }
